              ...
              <div class="col-md-5 bg-orange text-white p-4 p-md-5">
                ...
                <div class="d-flex align-items-start mb-4">
                  ...
                  <div>
                    ...
                    <p class="mb-0">First Floor, Keonics IT Park, LIG-2, , Kalaburagi, Karnataka 585103, Akkamahadevi Colony, Ganagapur Road-585213</p>
                  </div>
                </div>
                ...
                <div class="d-flex align-items-start mb-4">
                  ...
                  <div>
                    ...
                    <p class="mb-0">info@digitalakash.in</p>
                  </div>
                </div>
