  ...
  <div class="container my-4 position-relative">
    <form action="search.php" method="get" class="d-flex justify-content-center position-relative">
      <div class="input-group position-relative w-100" style="max-width: 800px; height: 50px;">
        <input type="text" class="form-control shadow-sm rounded-start border-orange" name="q" id="searchInput"
          autocomplete="off" placeholder="Search stories..." required>
        <button class="btn btn-orange rounded-end px-4" type="submit">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search me-1"
            viewBox="0 0 16 16">
            <path
              d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001l3.85 3.85a1 1 0 0 0 1.415-1.415l-3.85-3.85zm-5.242.656a5.5 5.5 0 1 1 0-11 5.5 5.5 0 0 1 0 11z" />
          </svg>
          Search
        </button>

        <!-- Suggestions List -->
        <ul id="suggestions" class="list-group position-absolute w-100 start-0 top-100 mt-1 shadow-sm"
