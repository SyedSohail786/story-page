  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link px-3 active" href="about.php">
            <span class="d-flex align-items-center">
        ...
        <div class="card shadow-sm border-0 overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-6 d-none d-md-block">
              <div class="h-100" style="background: url('assets/images/about-hero.jpg') center/cover;"></div>
            </div>
            
            <!-- Content Column -->
            <div class="col-md-6">
              <div class="card-body p-4 p-md-5">
                <h2 class="mb-4" style="color: #fd7e14;">Our Story</h2>
                <p class="lead text-muted">
                  Welcome to <span class="fw-bold" style="color: #fd7e14;">StoryPortal</span>, where every voice matters and every story finds its audience.
                </p>
                
                <div class="d-flex mb-4">
                  <div class="me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fd7e14" class="bi bi-check-circle" viewBox="0 0 16 16">
                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                  ...
                  <div>
                    <h5>Our Mission</h5>
                    <p>To create a platform that empowers storytellers and connects them with audiences who appreciate authentic, meaningful content.</p>
                  </div>
                </div>
                
                <div class="d-flex mb-4">
                  <div class="me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fd7e14" class="bi bi-people" viewBox="0 0 16 16">
                  ...
                  <div>
                    <h5>Our Community</h5>
                    <p>Thousands of writers and readers come together daily to share experiences, learn from each other, and find inspiration.</p>
                  </div>
                </div>
                
                <div class="d-flex mb-4">
                  <div class="me-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fd7e14" class="bi bi-book" viewBox="0 0 16 16">
                  ...
                  <div>
                    <h5>Our Content</h5>
                    <p>Curated stories across diverse categories, ensuring quality and relevance for our readers.</p>
                  </div>
                </div>
                
                <div class="mt-4 pt-2">
                  <a href="list-story.php" class="btn text-white px-4 py-2" style="background-color: #fd7e14;">
